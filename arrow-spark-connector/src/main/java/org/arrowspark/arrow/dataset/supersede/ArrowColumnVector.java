package org.arrowspark.arrow.dataset.supersede;
...
public final class ArrowColumnVector extends ColumnVector {
    ...
    private abstract static class ArrowVectorAccessor {
        ...
        // note: should be final after removing ArrayAccessor workaround
    ...
    private static class ArrayAccessor extends ArrowVectorAccessor {
        ...
        final boolean isNullAt(int rowId) {
            // note: Workaround if vector has all non-null values, see ARROW-1948
     ...
     *
     * Access struct values in a HackArrowColumnVector doesn't use this accessor. Instead, it uses
